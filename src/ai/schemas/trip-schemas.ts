...
export const PlanTripInputSchema = z.object({
  ...
  travelDate: z.string().optional().describe('Optional date of travel (e.g., "tomorrow", "next Monday", "2024-12-25"). This can influence weather suggestions. Expected format if a date is picked: "yyyy-MM-dd".'),
});
